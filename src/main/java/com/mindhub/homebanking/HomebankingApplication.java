...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
        ...
        return (args) -> {
            ...
            Account account1 = new Account(AccountController.createNumberAccount(), LocalDate.now(), 5000);
            Account account2 = new Account(AccountController.createNumberAccount(), LocalDate.now().plusDays(1), 7500);
            Account account3 = new Account(AccountController.createNumberAccount(), LocalDate.now(), 8500);
            Account account4 = new Account(AccountController.createNumberAccount(), LocalDate.now(), 850000);
