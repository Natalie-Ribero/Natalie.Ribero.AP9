...
public class HomebankingApplication {
    ...
    public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
        ...
        return (args) -> {
            ...
            Card card1 = new Card(client1.toString(), CardType.DEBIT, CardColor.GOLD, Card.createNumberCard(), CardController.createCvv(),
                    LocalDate.now(), LocalDate.now().plusYears(5));
            Card card2 = new Card(client1.toString(), CardType.CREDIT, CardColor.TITANIUM, Card.createNumberCard(), CardController.createCvv(),
                    LocalDate.now(), LocalDate.now().plusYears(5));
            Card card3 = new Card(client2.toString(), CardType.CREDIT, CardColor.SILVER, Card.createNumberCard(), CardController.createCvv(),
                    LocalDate.now(), LocalDate.now().plusYears(5));
